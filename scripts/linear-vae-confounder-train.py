...
import numpy as np
import torch
from catvae.trainer import LightningConfounderLinearVAE
...
def main(args):
    ...
    if args.load_from_checkpoint is not None:
        model = LightningConfounderLinearVAE(args)
...
if __name__ == '__main__':
    ...
    parser = LightningConfounderLinearVAE.add_model_specific_args(parser)

...
class LightningCountVAE(pl.LightningModule):
    ...
    def validation_epoch_end(self, outputs):
        ...
        self.logger.experiment.add_scalar('val_rec_err', rec_err, self.global_step)
...
class LightningLinearVAE(pl.LightningModule):

    def __init__(self, args):
        super(LightningLinearVAE, self).__init__()
        self.hparams = args
